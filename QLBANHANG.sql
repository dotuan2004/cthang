...
INSERT INTO NHANVIEN (msnv, hoten, gioitinh, namsinh, diachi, hinh, username, password)
VALUES 
(1, N'Nguyễn Văn B', N'Nam', '1985-06-15', N'Hà Nội', NULL, 'nvanb', 'password123'),
(2, N'Trần Thị C', N'Nữ', '1990-03-20', N'HCM', NULL, 'ttc', 'password456');
...
END
go
INSERT INTO KHACHHANG (mskh, hoten, gioitinh, namsinh, diachi, sdt, username, password)
VALUES 
(1, N'Nguyễn Văn A', N'Nam', '2000-12-01', N'HCM', '0987654321', 'nva', '123456'),
(2, N'Phạm Thị D', N'Nữ', '1998-07-20', N'Đà Nẵng', '0912345678', 'ptd', 'abcdef');
